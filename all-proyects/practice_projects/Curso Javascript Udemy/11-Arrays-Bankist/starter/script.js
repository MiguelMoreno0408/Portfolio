...
const dogsCopy = dogs.sort((b, a) => a.recommendedFood - b.recommendedFood);
console.log(dogsCopy);
//
//
//
//map(dog => dog.recommendedFood).sort((a, b) => a - b)
//
//
//
//
